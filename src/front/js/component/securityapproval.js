...
export const SecurityApproval = () => {
  ...
  useEffect(() => {
    console.log("se cargo la pag SecurityApproval")
  }, [])

  haveRole = actions.userContainsRole("security")
  const filterbystatus = localContracts.filter(contract => contract.status === "Pending_Security_approval");
  ...
  return (
    <>
      <main id="main" className="main mt-5 pt-5">
        ...
        <h1 className="border-bottom border-blue border-4 mt-2 mb-5" style={{ color: "blue" }}>Pending Security Approval</h1>
        <ul>
          <div class="card">
            <div class="card-body">
